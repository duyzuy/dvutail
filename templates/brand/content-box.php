...
<article class="w-full border-b pb-6 mb-6">
    <div class="inner flex flex-wrap lg:items-center">
        <div class="activity-date lg:w-60 w-32 lg:pr-8 pr-3 font-[Monsterat]">
            ...
            <div class="activity-content w-full lg:w-3/4">
                <div class="header-box">
                    <h3 class="font-[Monsterat]">
                        <a href="<?php the_permalink(); ?>" class="bg-gradient-to-tr from-[#CC2027] via-[#EB7121] to-[#F48820] text-transparent bg-clip-text uppercase font-bold text-xl lg:text-2xl lg:leading-[2.3rem] mb-3 block" alt="<?php the_title() ?>"><?php the_title(); ?> </a>
                    </h3>
