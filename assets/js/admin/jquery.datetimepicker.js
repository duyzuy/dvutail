    ...
    return (
            ...
            defaults: {
                dateSettings: {
                    ...
                    ordinal: function (t) {
                        var e = t % 10,
                            n = { 1: "st", 2: "nd", 3: "rd" };
                        return 1 !== Math.floor((t % 100) / 10) && n[e]
                            ? n[e]
                            : "th";
                    },
                },
        ...
        (t.prototype = {
            ...
            parseDate: function (t, n) {
                ...
                if ("U" === n)
                    return (u = e.getInt(t)), u ? new Date(1e3 * u) : t;
                switch (typeof t) {
                    case "number":
                        return new Date(t);
                    case "string":
                    ...
                    (r = {
                        ...
                        B: function () {
                            var t = n.getUTCHours() * e.HOUR,
                                ...
                                a = n.getUTCSeconds();
                            return e.lpad(
                                Math.floor((t + r + a + e.HOUR) / 86.4) % 1e3,
                                3
                            );
                        },
                        g: function () {
            ...
            formatDate: function (t, n) {
                var r,
                    ...
                    c = "",
                    f = "\\";
                if ("string" == typeof t && ((t = s.parseDate(t, n)), !t))
                    return null;
            ...
            function setMask(options) {
                ...
                if (typeof options.mask === "string") {
                    ...
                    input.on("paste.xdsoft", function (event) {
                        ...
                        var valueAfterPaste = val.substr(
                    ...
                    input.on("keydown.xdsoft", function (event) {
                        ...
                        if (
                            ...
                            while (true) {
                                var maskValueAtCurPos = options.mask.substr(
                                    pos,
                                    1
                                );
                            ...
                            if (hasSel) {
                                ...
                                var defaultBlankSelectionReplacement =
                                    defaultBlank.substr(pos, selLength);
                                ...
                                var charsAfterSelection = val.substr(
                                    pos + selLength
                                );
