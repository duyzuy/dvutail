...
class Postbycategory extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'dv_archive_post_themes', 'DV - Post by cat', $widget_ops );
	}
...
function dv_category_post_themes_widget() {
	register_widget( 'Postbycategory' );
}

add_action( 'widgets_init', 'dv_category_post_themes_widget' );