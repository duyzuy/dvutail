...
function neo_ajax_enqueue_script()
{
    ...
    wp_localize_script('dvu-ajax', 'neo_object', array(
...
add_action('wp_ajax_nopriv_sghsend_contact_action', 'sghsend_contact_action');
add_action('wp_ajax_sghsend_contact_action', 'sghsend_contact_action');
function sghsend_contact_action()
{
