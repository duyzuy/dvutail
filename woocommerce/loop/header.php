...
?>
<div class="woocommerce-products-header lg:mb-6 mb-3">
	<?php
	/**
	...
	?>
		<h1 class="woocommerce-products-header__title page-title text-2xl lg:text-4xl"><?php woocommerce_page_title(); ?></h1>
	<?php endif; ?>
