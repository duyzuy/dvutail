...
?>
	<div class="woocommerce-terms-and-conditions-wrapper">
		<div class="term text-xs lg:text-sm text-gray-600 py-3">
			<?php
			/**
		...
		<?php if (wc_terms_and_conditions_checkbox_enabled()) : ?>
			<p class="form-row validate-required">
				<label class="woocommerce-form__label woocommerce-form__label-for-checkbox checkbox flex items-center w-full py-2">
					<input type="checkbox"
						class="woocommerce-form__input woocommerce-form__input-checkbox input-checkbox mr-2"
