...
<form class="woocommerce-shipping-calculator pt-3" action="<?php echo esc_url(wc_get_cart_url()); ?>" method="post">

	<?php printf('<a href="#" class="shipping-calculator-button underline text-blue-600 mb-3 inline-block">%s</a>', esc_html(! empty($button_text) ? $button_text : __('Calculate shipping', 'woocommerce'))); ?>

	<section class="shipping-calculator-form" style="display:none;">

		<?php if (apply_filters('woocommerce_shipping_calculator_enable_country', true)) : ?>
			<p class="form-row form-row-wide mb-3" id="calc_shipping_country_field">
		...
		<?php if (apply_filters('woocommerce_shipping_calculator_enable_state', true)) : ?>
			<p class="form-row form-row-wide mb-3" id="calc_shipping_state_field">
				<?php
		...
		<?php if (apply_filters('woocommerce_shipping_calculator_enable_city', true)) : ?>
			<p class="form-row form-row-wide mb-3" id="calc_shipping_city_field">
		...
		<?php if (apply_filters('woocommerce_shipping_calculator_enable_postcode', true)) : ?>
			<p class="form-row form-row-wide mb-3" id="calc_shipping_postcode_field">
		...
		<?php endif; ?>
		<p class="text-right"><button type="submit" name="calc_shipping" value="1" class="px-3 py-2 border-rose-600 text-rose-600 border text-sm w-fit rounded-md button<?php echo esc_attr(wc_wp_theme_get_element_class_name('button') ? ' ' . wc_wp_theme_get_element_class_name('button') : ''); ?>"><?php esc_html_e('Update', 'woocommerce'); ?></button></p>
